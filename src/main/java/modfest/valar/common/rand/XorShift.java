...
public class XorShift
{
	 ...
	 *
	 */
	public final class Instance implements IRandom<XorShift.Instance>
	{
		private long x, y, z;
		...
		@Override
		public XorShift.Instance create(long seed, double[] settings)
		{
			return XorShift.create(seed).getInstance();
		}
	}
